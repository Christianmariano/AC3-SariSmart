...
<head>
    ...
    <title>AC³SariSmart - About Us</title>
...
<body>
    ...
    <header>
        ...
        <div class="aboutus-center">
            <img src="./images/logo.png" alt="Error" style="width:150px;">
            <h1>AC<sup>3</sup>SariSmart</h1>
            <br>
            <p>
                Welcome to AC<sup>3</sup> SariSmart Your Modern Sari-Sari Store Solution.
                At AC<sup>3</sup> SariSmart, we're redefining the traditional tindahan experience by blending the warmth and familiarity of a sari-sari store with the power of smart technology.
                Founded with a vision to help small retailers grow and thrive, AC<sup>3</sup> SariSmart doesn't just sell products — we empower sari-sari store owners to track sales, monitor inventory, and manage their business efficiently. 
                Whether you're running a corner store in the barangay or managing multiple outlets, our platform gives you the tools to stay on top of your operations.
                We believe in digital tools made simple — no technical jargon, no complicated systems. Just a smart, easy-to-use platform made for Filipinos, by Filipinos.
            </p>
            <br>
        </div>
    </header>
