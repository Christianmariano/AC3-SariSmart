...
<head>
    ...
    <title>AC³SariSmart - Contact Us</title>
    <style>
        /* Popup Styles */
        .popup {
            position: fixed;
...
<body>
    ...
    <header>
        ...
        <div class="aboutus-center">
            <img src="./images/logo.png" alt="Error" style="width:150px; margin-bottom:20px;">
            <h1>AC<sup>3</sup>SariSmart</h1>
            <h2>Contact Us</h2>
            <br>
            <p>For any inquiries or further information, you may contact AC <sup>3</sup>SariSmart through email at AC <sup>3</sup>SariSmart@gmail.com or via mobile at +63 962 931 0707. 
