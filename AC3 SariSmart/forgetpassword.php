...
<body>
    ...
    <div class="container">
        ...
        <div class="profile-form-container">
            <form action="forgetpassword_password.php" method="POST" enctype="multipart/form-data" class="profile-form">
              ...
              <button type="submit" class="btn-submit">Forget Password</button>
            </form>
          </div> 
    </div>
</body>
...
<!--END Responsive Nav Bar-->
    ...
    <script src="asset/js/search_bar_microphone_forgetpassword"></script>
    <script src="asset/js/POPUP_message_forgetpassword.js"></script>
</body>
</html>